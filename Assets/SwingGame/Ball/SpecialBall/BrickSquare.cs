...
{
    public BrickSquare(bool tooltip = true) : base()
    {
        this.BallObject = GameObject.Instantiate(Resources.Load("Prefabs/PU_BrickSquare", typeof(GameObject))) as GameObject;

        LocalizedString header = new LocalizedString("PowerUp", "brickSquare_h");
        LocalizedString content = new LocalizedString("PowerUp", "brickSquare_c");
